$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Boda de Karly y Miguel",

            // Event start date
            start: new Date('Feb 13, 2027 15:00'),
            ...
            end: new Date('Feb 13, 202027 11:59'),

            // Event Address
            address: 'Salón y Jardín Los Pilares, Salamanca Gto.',

            // Event Description
            description: "Esperamos que puedas unirte a nuestra celebración, para más información o dudas contactar al correo miguelnunez951028@gmail.com."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        var phoneInput = $('input[name="phone"]', this);
        var phoneValue = phoneInput.val().trim();
        var numericPhone = phoneValue.replace(/\D/g, '');
        if (numericPhone.length < 10) {
            $('#alert-wrapper').html(alert_markup('danger',
                '<strong>¡Atención!</strong> Por favor ingresa un número de teléfono válido de al menos 10 dígitos.'
            ));
            return;
        }
        ...
        $.post(scriptUrl, data)
            ...
            .fail(function (jqXHR, textStatus, errorThrown) {
                ...
                $('#alert-wrapper').html(alert_markup('danger', '<strong>Lo sentimos!</strong> Hubo un problema al enviar tus datos. Intenta de nuevo.'));
            });
    });
    /********************** RSVP END **********************/
...
// Google map
function initMap() {
    var location = {lat: 20.59882857717041, lng: -101.17712301044365};
...
function initBBSRMap() {
    var la_fiesta = {lat: 20.59882857717041, lng: -101.17712301044365};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
